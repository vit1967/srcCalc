...
приложение не выбрасывает исключение и  не завершает свою работу"
    - проверяю -ввожу "белиберду" или просто цифру ,и не ввожу знак операции -прерывается с "Что-то пошло не так:null"
может быть случайно 1ну из 2х настроечных переменных
...
установили в false (и правильно! Зачем же себя ограничивать?;)?

вычисление  в римских числах возвращает результат арабскими.
    -V solved
...................
...
т.е. вида  2+5 -6 / 2
или , если установить в начале класса onlyFrom0to10=false;  //по дефолту стоит в true -нстройка ограничения вводимых цифр только от 0 до 10(по усл. задачи)
